...
export default function CombinedModal({openCombinedModal,setOpenCombinedModal,setOpenFirstModal}) {
    const [secondModalInfo,setSecondModalInfo] = useState('Pertambahan')
    ...
    return (
        <>
        {openCombinedModal && 
        <div onClick={closeCombinedModal} className='absolute top-0 left-0 bottom-0 right-0 bg-black bg-opacity-50 px-10 pt-10 gap-x-1'>
